...
function AddFoodForm(props) {
  ...
  const handlePorcionesComida = (event) =>
    setNuevasPorciones(event.target.value);
  ...
  return (
    <form onSubmit={handleFormSubmit}>
      ...
      <Input
        type="number"
        name="servings"
        onChange={handlePorcionesComida}
